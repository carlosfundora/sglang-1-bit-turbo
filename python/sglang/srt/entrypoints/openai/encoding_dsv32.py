...
try:
    from sglang.sglang_rust_utils import parse_message_from_completion_text as _parse_message_from_completion_text_rust
...
def parse_message_from_completion_text(text: str, thinking_mode: str):
    if RUST_UTILS_AVAILABLE:
        try:
            return _parse_message_from_completion_text_rust(text, thinking_mode)
