...
class SglSamplingParams:
    ...
    def clone(self):
        return SglSamplingParams(
            ...
            self.min_new_tokens,
            self.n,
            list(self.stop) if isinstance(self.stop, list) else self.stop,
            list(self.stop_token_ids) if isinstance(self.stop_token_ids, list) else self.stop_token_ids,
            list(self.stop_regex) if isinstance(self.stop_regex, list) else self.stop_regex,
            self.temperature,
            self.top_p,
            self.top_k,
            self.min_p,
