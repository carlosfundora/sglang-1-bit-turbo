...
# Let's put the import inside the init function of MambaRadixCache so we don't break module imports!
# But wait, we can just put it at the very bottom of the file! No, RUST_UTILS_AVAILABLE needs to be accessible in methods.
# Actually, the simplest is to put it at the end of the file as a global variable.
content += "\n" + import_block
