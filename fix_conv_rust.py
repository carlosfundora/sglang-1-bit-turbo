...
impl ConversationRust {
    #[new]
    #[pyo3(signature = (name, system_template, system_message, roles, sep_style_int, sep, sep2, messages, image_token))]
    fn new(
        name: String,
    ...
    fn get_prompt_rust(&self) -> String {
        ...
        let system_prompt = self.system_template.replace("{system_message}", &self.system_message);
            ...
            match self.sep_style {
                ...
                SeparatorStyle::Llama2 => {
                    if !content.is_empty() {
                        ...
                        if i == 0 && self.system_message.is_empty() {
                            prompt.push_str("[INST] ");
                        } else {
                            prompt.push_str("<s>[INST] ");
                        }
